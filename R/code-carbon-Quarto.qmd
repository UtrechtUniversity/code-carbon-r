...
format:
  html:
    ...
    code-links:
        - text: "GitHub"
          href: https://github.com/UtrechtUniversity/code-carbon-r
          icon: github
...
The following workflow is available in the [**code-carbon-script.R**](https://github.com/UtrechtUniversity/code-carbon-r/blob/main/R/code-carbon-script.R), which you can reuse and adapt to test your code.
